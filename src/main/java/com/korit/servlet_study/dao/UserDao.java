...
public class UserDao {
    ...
    public User findById(int id) {
        ...
        try {
            con = db.DBConnectionMgr.getInstance().getConnection();
            String sql = """
                    select
                        user_id,
                        username,
            ...
            db.DBConnectionMgr.getInstance().freeConnection(con, ps, rs);
        }
    ...
    public Optional<User> save(User user) {
        ...
        try {
            ...
            db.DBConnectionMgr.getInstance().freeConnection(con, ps);
        }
